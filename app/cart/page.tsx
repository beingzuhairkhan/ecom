  ...
  return (
    <CustomerLayout>
      ...
      <div className="container mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold text-[#122B5F] mb-8">Shopping Cart</h1>
                      ...
                      <div className="sm:col-span-6 flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">
                            <Link href={`/products/${item.product.id}`} className="hover:text-[#122B5F]">
                              {item.product.name}
                            </Link>
                          </h3>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between font-semibold">
                    <span>Total</span>
                    <span className="text-lg text-[#122B5F]">${total.toFixed(2)}</span>
                  </div>
